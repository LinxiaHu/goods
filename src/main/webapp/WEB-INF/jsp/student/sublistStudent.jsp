...
<a href="${pageContext.request.contextPath}/queryUserLogin.action">返回</a><br>
	<div style="margin-left: 100px; margin-top: 100px;">
		<div>
			<font color="red">${errorMsg }</font>
		</div>
		<div>
			<form action="${pageContext.request.contextPath}/student/sublistServlet"   id="stuForm"  method="post">
				姓名
